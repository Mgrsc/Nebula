...
export const strings = {
  "zh-CN": {
    ...
    defaultWebhookTitle: "默认通知渠道",
    defaultWebhookDesc: "新增订阅时会默认勾选这些渠道。",
    applyToAllSubscriptions: "应用到所有订阅",
    applyToAllConfirm: "将默认渠道应用到所有订阅的通知渠道，是否继续？",
    applyToAllDonePrefix: "已应用到订阅数量：",
  ...
  en: {
    ...
    defaultWebhookTitle: "Default Channels",
    defaultWebhookDesc: "New subscriptions will preselect these channels.",
    applyToAllSubscriptions: "Apply to all subscriptions",
    applyToAllConfirm: "Apply default channels to all subscriptions now?",
    applyToAllDonePrefix: "Applied to subscriptions: ",
